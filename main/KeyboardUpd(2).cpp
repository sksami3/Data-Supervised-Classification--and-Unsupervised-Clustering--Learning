...
void human()
 ...
 glPopMatrix();
	...
	glVertex3f(0.15, -1.6, 0.0);
	glVertex3f(0.2, -1.6, 0.0);
	glVertex3f(0.45, -1.73, 0.0);
	glVertex3f(0.15, -1.73, 0.0);
...
void update(int value) {
    ...
    if(moveobs <= 2.5 && manXL1<=posx-.45f && moveobs >= 2.3)///detects collision for car1
    {
        collide=1;

    }

    if(moveobs1 <= -9.5 && manXL1>=posx-.15f)///detects collision for car1  manXL1>=posx-.45f
    ...
    if(moveobs2 <= 4.8 && manXL1>=posx-.15f && moveobs2 >= 4.6)///detects collision for car1  manXL1>=posx-.45f
    ...
    if(moveobs4 <= -2.2 && manXL1<=posx-.45f && moveobs >= -2.3)///detects collision for && manXL1>=posx-.15f && moveobs2 >= 4.0
